...
import com.stonedog.gramophone.adapter.song.AlbumSongAdapter;
import com.stonedog.gramophone.dialogs.AddToPlaylistDialog;
import com.stonedog.gramophone.dialogs.DeleteSongsDialog;
import com.stonedog.gramophone.dialogs.SleepTimerDialog;
...
import com.stonedog.gramophone.lastfm.rest.LastFMRestClient;
import com.stonedog.gramophone.lastfm.rest.model.LastFmAlbum;
import com.stonedog.gramophone.loader.AlbumLoader;
import com.stonedog.gramophone.misc.SimpleObservableScrollViewCallbacks;
...
import com.stonedog.gramophone.ui.activities.tageditor.AlbumTagEditorActivity;
 ...
 */
public class RemoteAlbumDetailActivity extends AbsSlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Album> {

    public static final String TAG = RemoteAlbumDetailActivity.class.getSimpleName();
        ...
        lastFMRestClient.getApiService()
                ...
                .enqueue(new Callback<LastFmAlbum>() {
                    ...
                    public void onResponse(@NonNull Call<LastFmAlbum> call, @NonNull Response<LastFmAlbum> response) {
                        ...
                        if (!Util.isAllowedToDownloadMetadata(RemoteAlbumDetailActivity.this)) {
                            if (wiki != null) {
                                wikiDialog.setContent(wiki);
                            } else {
                                wikiDialog.dismiss();
                                Toast.makeText(RemoteAlbumDetailActivity.this, getResources().getString(R.string.wiki_unavailable), Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
