package com.stonedog.gramophone.service;
...
import com.stonedog.gramophone.appwidgets.AppWidgetBig;
import com.stonedog.gramophone.appwidgets.AppWidgetCard;
import com.stonedog.gramophone.appwidgets.AppWidgetClassic;
import com.stonedog.gramophone.appwidgets.AppWidgetSmall;
import com.stonedog.gramophone.glide.BlurTransformation;
import com.stonedog.gramophone.glide.SongGlideRequest;
import com.stonedog.gramophone.helper.ShuffleHelper;
import com.stonedog.gramophone.helper.StopWatch;
...
import com.stonedog.gramophone.provider.MusicPlaybackQueueStore;
import com.stonedog.gramophone.provider.SongPlayCountStore;
import com.stonedog.gramophone.service.notification.PlayingNotification;
import com.stonedog.gramophone.service.notification.PlayingNotificationImpl;
import com.stonedog.gramophone.service.notification.PlayingNotificationImpl24;
import com.stonedog.gramophone.service.playback.Playback;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String PHONOGRAPH_PACKAGE_NAME = "com.stonedog.gramophone";
    ...
    public void onCreate() {
        ...
        sendBroadcast(new Intent("com.stonedog.gramophone.PHONOGRAPH_MUSIC_SERVICE_CREATED"));
    }
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("com.stonedog.gramophone.PHONOGRAPH_MUSIC_SERVICE_DESTROYED"));
    }
    ...
    private boolean openCurrent() {
        synchronized (this) {
            try {
                return playback.setDataSource(getCurrentSong().data);
