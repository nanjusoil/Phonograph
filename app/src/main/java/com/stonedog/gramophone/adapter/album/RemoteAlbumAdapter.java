package com.stonedog.gramophone.adapter.album;
 ...
 */
public class RemoteAlbumAdapter extends AbsMultiSelectAdapter<RemoteAlbumAdapter.ViewHolder, Album> implements FastScrollRecyclerView.SectionedAdapter {

    public static final String TAG = RemoteAlbumAdapter.class.getSimpleName();
    ...
    public RemoteAlbumAdapter(@NonNull AppCompatActivity activity, ArrayList<Album> dataSet, @LayoutRes int itemLayoutRes, boolean usePalette, @Nullable CabHolder cabHolder) {
    ...
    protected void loadAlbumCover(Album album, final ViewHolder holder) {
        ...
        Glide.with(activity)
                .load("https://i.imgur.com/iwRzieR.png")
                .centerCrop()
                .into(holder.image);
    ...
    public class ViewHolder extends MediaEntryViewHolder {
        ...
        public void onClick(View v) {
            if (isInQuickSelectMode()) {
                ...
                NavigationUtil.goToRemoteAlbum(activity, dataSet.get(getAdapterPosition()).getId(), albumPairs);
            }
        }
