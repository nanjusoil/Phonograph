...
public class RemoteGenreAdapter extends RecyclerView.Adapter<RemoteGenreAdapter.ViewHolder> implements FastScrollRecyclerView.SectionedAdapter {

    public static final String TAG = RemoteGenreAdapter.class.getSimpleName();
    ...
    public RemoteGenreAdapter(@NonNull AppCompatActivity activity, ArrayList<Genre> dataSet, @LayoutRes int itemLayoutRes) {
